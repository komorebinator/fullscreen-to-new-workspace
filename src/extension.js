...
export default class FullscreenToNewWorkspace extends Extension {
    ...
    shouldPlaceBackToOldWorkspaceChange(win, change, rectold) {
        ...
        log("shouldPlaceBackToOldWorkspaceChange", win.get_id(), this.isNormalWindow(win), this.isMaximizeEnabled(), rectmax.equal(rectold), (win.get_maximized() !== Meta.MaximizeFlags.BOTH), (!win.fullscreen));
